# -*- coding: utf-8 -*-
"""
Created on Tue Apr 29 15:29:31 2025
...
# 4) 토크나이저 & 모델 로드 (classification head 새로 초기화)
...
# 11) 학습 실행
print("▶ Fine-tuning klue/bert-base 시작")
trainer.train()
...
logs_df.to_csv("klue_training_logs.csv", index=False, encoding="utf-8-sig")
...
plt.title("klue/bert-base Fine-tuning Metrics")
plt.xlabel("Epoch")
plt.ylabel("Score / Loss")
plt.legend()
plt.grid(True)
plt.savefig("klue_training_metrics.png", dpi=300)
plt.show()

# 14) 최종 모델 & 토크나이저 저장
save_dir = "./klue_finetuned_model"
