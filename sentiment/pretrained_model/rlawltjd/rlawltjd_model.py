# -*- coding: utf-8 -*-
"""
Created on Tue Apr 29 15:25:40 2025
...
# 11) 학습 실행
print("▶ Fine-tuning rlawltjd/kobert-sentiment 시작")
trainer.train()
...
logs_df.to_csv("rl_training_logs.csv", index=False, encoding="utf-8-sig")
...
plt.title("rlawltjd/kobert-sentiment Fine-tuning Metrics")
plt.xlabel("Epoch")
